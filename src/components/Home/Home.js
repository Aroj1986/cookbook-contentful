...
function Home() {
  ...
  return (
    <>
        ...
        <div className="row">
          <div className="col col-md-9">
            ...
            <p>
              ...
              starting out in the kitchen, we have something for everyone. In
              our recipe collection, you'll find a wide variety of dishes to
              choose from, including appetizers, main courses, sides, and
              desserts. We have recipes for all types of dietary restrictions
              and preferences, including vegetarian, vegan, gluten-free, and
              low-carb options. Not sure what to make? Check out our featured
              recipes section for some inspiration. You can also search for
              recipes by ingredient, cuisine, or occasion. We hope you enjoy
              exploring our site and trying out our recipes. Happy cooking!
            </p>
            <div className="row">
              <div class="hr-sect">
      ...
      <Helmet>
        <title>Easy Peasy - Home</title>
        <meta name="Home section Easy Peasy Recips" content="Home" />
      </Helmet>
    </>
  );
}
